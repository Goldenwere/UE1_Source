...
This is the source code for *[Unknown Entity](https://www.indiedb.com/games/unknown-entity)*. *Unknown Entity* is a sci-fi first-person-shooter designed by [Lightling](http://lightling.xyz), developed and published under the name Light_Studios (now Goldenwere). UE has officially been on hiatus since 2018 September 02.
...
-- Description from [the official game page](https://goldenwere.surge.sh/projects/ue1)
...
The document [Changes For the Future](ChangesForFuture.md) highlights what would be changed if the project was taken out of hiatus in the state it was left. However, if UE 1 development ever resumed, it would take place in a completely different project.
